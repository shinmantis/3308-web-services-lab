...
#source https://stackoverflow.com/questions/13921910/python-urllib2-receive-json-response-from-url
for x in range (5):
  state = gps[x]['state']
  lat = gps[x]['latitude']
  lon = gps[x]['longitude']
  abbrev = us_state_abbrev[state]
  url = 'https://api.forecast.io/forecast/yourapikeyhere/{},{}'.format(lat, lon)
  response = urllib2.urlopen(url)
  data = json.load(response)   
  colorTemp = colorMap(data['currently']['temperature'])
  javascript = javascript + "document.getElementById('{}').setAttribute('fill', '{}');".format(abbrev, colorTemp);
  time.sleep( .5 )
...
print('''
 ...
 <html>
 <head>
   <title>Weather Map Lab by Your Garcia</title>
 </head>
 <body>
